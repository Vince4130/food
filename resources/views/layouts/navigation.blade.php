<nav x-data="{ open: false }" class="border-b border-gray-100 dark:bg-gray-800">
    <!-- dark:bg-gray-800  -->
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a data-bs-toggle="tooltip" data-bs-title="Home" data-bs-placement="bottom" href="{{ route('dashboard') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('targets.index')">
                                    {{ __('Résumé de vos données') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('targets.create')">
                                    {{ __('Saisir votre objectif') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
            ...
            <div class="flex items-center">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                <div>{{ (Auth::user()->pseudo !== null) ? Auth::user()->pseudo : Auth::user()->firstname }}</div>
                                <div class="ms-1">
                                    <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                                    </svg>
                    ...
                    <!-- <div class="change-mode">
                        <button id="theme-toggle" class="dark:bg-gray-200 dark:text-black"><i class="fa-solid fa-circle-half-stroke"></i></button>
                    </div> -->
                    <!-- <div class="change-mode">
